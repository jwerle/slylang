...
#define SLY_TOKENS                                         \
  ...
  X(OP_DIVIDE_ASSIGN, "/=")                                \
  X(OP_BITWISE_AND, "&")                                   \
  X(OP_BITWISE_AND_ASSIGN, "&=")                           \
  X(OP_BITWISE_OR, "|")                                    \
  X(OP_BITWISE_OR_ASSIGN, "|=")                            \
  X(OP_BITWISE_XOR, "^")                                   \
  X(OP_BITWISE_XOR_ASSIGN, "^=")                           \
  X(OP_BITWISE_NOT, "~")                                   \
  X(OP_BITWISE_SHIFT_LEFT, "<<")                           \
  X(OP_BITWISE_SHIFT_LEFT_ASSIGN, "<<=")                   \
  X(OP_BITWISE_SHIFT_RIGHT, ">>")                          \
  X(OP_BITWISE_SHIFT_RIGHT_ASSIGN, ">>=")                  \
  X(OP_BITWISE_UNSIGNED_SHIFT_RIGHT, ">>>")                \
  X(OP_BITWISE_UNSIGNED_SHIFT_RIGHT_ASSIGN, ">>>=")        \
